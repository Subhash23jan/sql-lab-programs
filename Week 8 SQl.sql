...
insert into flight values(1,'bangalore','delhi',500,'6:00:00','9:00:00',5000);
insert into flight values(2,'bangalore','chennai',300,'07:00:00','08:30:00',3000);
...
insert into aircraftt values(1,'airbus',2000),(2,'boeing',700),(3,'	jetairways',550),(4,'indigo',5000),(5,'boeing',4500),(6,'airbus',2200);
...
select aname from aircraftt a,certified  c where 
a.aid=c.aid and c.eid in (select e.eid from employee e where e.salary>=80000);
...
group by e.eid having count(c.aid)>=3;


#3 Find the names of pilots whose salary is less than the price of the cheapest route from Bengaluru to Frankfurt.
select e.ename from employee e
where e.salary<(select min(f.price) from flight f where f.fromm='bangalore' and f.too='frankfurt');
...
select distinct e.ename from employee e, certified c, aircraftt a
